...
public class Volumen extends UnidadMedida {
	...
	public float Conversion(String comparador, float valorTransformar) {
		...
		if(this.getNombre().equalsIgnoreCase("Cuchara de t�"))
		{
			switch(comparador)
			{
				case "Cuchara de t�":
		...
		if(this.getNombre().equalsIgnoreCase("Cuarto de gal�n"))
		{
			switch(comparador)
			{
				case "Cuarto de gal�n":
		...
		if(this.getNombre().equalsIgnoreCase("Gal�n"))
		{
			switch(comparador)
			{
				case "Gal�n":
		...
		if(this.getNombre().equalsIgnoreCase("Mil�metros cb"))
		{
			switch(comparador)
			{
				case "Mil�metros cb":
		...
		if(this.getNombre().equalsIgnoreCase("Cent�metros cb"))
		{
			switch(comparador)
			{
				case "Cent�metros cb":
